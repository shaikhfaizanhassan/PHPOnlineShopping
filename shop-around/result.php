      ...
      <div class="products">
        ...
        <ul>
          <?php
				...
				$search_pro = "select * from products where product_keyword like '%$user_keywords%'";
				$run_search = mysqli_query($con,$search_pro);
				while($row_search = mysqli_fetch_array($run_search))
				{
							$pro_id 	= 	$row_search[0];
							$pro_title 	= 	$row_search[4];
							$pro_cat 	= 	$row_search[1];
							$pro_brand 	= 	$row_search[2];
							$pro_desc 	= 	$row_search[9];
							$pro_price 	= 	$row_search[8];
							$pro_image1 = 	$row_search[5];
							$pro_image2 = 	$row_search[6];
							$pro_image3 = 	$row_search[7];
					echo "
		<li style='width:300px; margin:10px; border:1px solid; height:px; padding:5px; 
		margin-left:30px;'> <a 
